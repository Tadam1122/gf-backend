      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            pedal = req.body;
            pedalId = req.body.id;
            console.log("updating effect pedal with id ".concat(pedalId));
            _context3.next = 5;
            return (0, _connect.connectClient)();

          case 5:
            client = _context3.sent;
            db = client.db(process.env.MONGO_DBNAME || 'guitar-finder'); //update pedals
          ...
          case 9:
            client.close();
            return _context3.abrupt("return", res.status(200).json(pedal));
